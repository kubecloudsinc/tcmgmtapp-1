package com.cisco.cstg.autotools.support.email;
...
import com.cisco.cstg.autotools.support.configuration.ConfigurationFile;
import com.cisco.cstg.autotools.support.exception.Assertion;
import com.cisco.cstg.autotools.support.exception.Fault;
...
public class EmailLocator implements EmailCatalog {
	 ...
	 * 
	 * @see com.cisco.cstg.autotools.support.email.EmailCatalog#lookUp(java.lang.String)
	 */
