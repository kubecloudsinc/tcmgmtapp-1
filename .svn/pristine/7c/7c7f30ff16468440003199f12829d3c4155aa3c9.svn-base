 ...
 *
 */
public class PSSPageLoadTimeTestConscia extends BaseTest {
	
	private final Logger logger = LoggerFactory.getLogger(PSSPageLoadTimeTestConscia.class);
