...
public class TestCaseStatus extends IdentifiableEntity implements Comparable{

    private static final long serialVersionUID = 2922429267460500809L;
    ...
    public boolean equals(Object o) {
        ...
        if (this == o) {
            ...
            return false;
        } else if (o instanceof TestCaseStatus) {
            TestCaseStatus that = (TestCaseStatus) o;
