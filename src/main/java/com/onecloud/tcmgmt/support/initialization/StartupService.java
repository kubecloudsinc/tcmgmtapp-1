package com.onecloud.tcmgmt.support.initialization;

import com.onecloud.tcmgmt.support.configuration.*;
import com.onecloud.tcmgmt.support.exception.Assertion;
import com.onecloud.tcmgmt.support.log.Log;
import com.onecloud.tcmgmt.support.log.SystemLog;
...
public class StartupService implements Startable {
    ...
    /**
     * Allows a dto subclass the opportunity to inject a substitute collaborator.
     *
